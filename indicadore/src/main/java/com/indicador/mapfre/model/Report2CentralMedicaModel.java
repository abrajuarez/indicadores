...
public class Report2CentralMedicaModel {

	Timestamp cmcreationDate;
	String cmcodSector;
	...
	String cmestadoRepublica;//11
	String cmnivelHospitalario;
	String cmfechaIngreso;
	String cmurgencia;//15
	String cmhabitacionAsignada;
	String cmnumeroPoliza;
	String cmramo;
	String cmpolizaPagadaHasta;
	String cminicioVigencia;//20
	String cmfinVigencia;//21
	String cmpolProcesoEmision;//22
	String cmnombreContratante;
	String cmrecienNacido;//24
	String cmapellidoPaternoPaciente;
	String cmapellidoMaternoPaciente;
	String cmprimerNombrePaciente;
	String cmsegundoNombrePaciente;//28
	String cmnumeroRiesgo;
	String cmfechaNacimientoPaciente;//30
	String cmgeneroPaciente;
	String cmtitularPoliza;
	String cmmedicoRed;
	String cmnombreMedico;
	String cmespecialidadMedico;
	String cmredProveedor;
	String cmsintomasDiagnostico;
	String cmfemiliarResponsable;//38
	String cmtelFamiliarResponsable;//39
	String cmnombreReportante;//40
	String cmtelefonoReportante;//41
	String cmemailReportante;//42
	String cmobservacionesIngreso; //->43
	String cmnivelComplejidad;//44
	String cmusuarioAsignado;// 45  46
	
	String cmtipoTramite;
	String cmterritorioAtencion;
	String cmtipoMoneda;
	String cmfechaPrealtaHospitalaria;//
	String cmfechaEgresoHospitalaria;
	String cmtieneInsumoRecobro;
	String cmimporteEdoCuentaSdesv;
	String cmdesviosEdoCuenta;
	String cmbaseIndemnizacion;
	String cmmontoAutHospital;
	String cmmontoConIva; //65
	String sinnumeroSiniestro;
	String sinestado;
	...
	String sindescDiagnostico;//61
	String sinfechaOcurrencia;
	String sincausa;
	String sinconsecuencia;
	String sinfechaInicioSintomas;
	String sincoberturaAfectada;//66
	String sintipoPago;
	String sintipoReserva;
	String cptclaveCpt;//82
	String cptdescripcionCpt;//83
	String sindeducibleContratado;
	String sinreduccionDeducible;//
	String sinincrementoDeducible;
	String sintotalDeducible;
	String sincoaseguroContratado;//75
	String sinredCoaSeguroHosp;
	String sinincCoaseguroHosp;// 77
	String sintopeCoaseguro;
	String sintipoTopeCoaseguro;
	String sintotalCoaseguroHosp;//80
	String hmedintegrante;//95
	String hmednombreMedico;//96
	String hmedespecialidad;//97
	String hmedmontoAutorizado;//98
	String hmedfolioRam;//99
	String hmedtipoPago; //100
		
	String hmedtipoReserva;//101
	String sintotalAutorizadoHm;//102
	String sincoaseguroMedico;//103
	String sinredCoaseguroMed;//104
	String sintotalCoaseguroMed;//105
	String cmcoaseguroMedico;
	String cmtotalCargoPaciente;
	String mediproveedor; //94
	String medidescripcionMedicamento;// 
	String medicodigoMedicamento;
	String medicantidad;
	String mediprecioAutUnidad;
	String sintotalAutorizadoMed;
	String sinfolioRamMed;
	String sindeducibleMedicamentos;
	String sincoaseguroMedicamentos;//102
	String sintotalMedicamentos;
	String serviciotipoServicio;//104
	String serviciorazonSocial;
	String serviciocantidad;
	String servicioprecioAutUnidad;
	String sintotalAutorizadoServ;
	String sinfolioRamServ;
	String sindeducibleServicios;//110
	String sincoaseguroServicios;
	String sintotalServicios;
	String cmbaseRechazo;
	String valorMedicoTratante;
	String valorEspecialidad;
	String valorMontoAutorizado; 
	String valorTipoPago; 
	String valorTipoReserva;
	String docTipoDocumento;
	
	public Report2CentralMedicaModel() {
		
	}
	public Report2CentralMedicaModel(Timestamp cmcreationDate, String cmcodSector, String cmidTipoSolicitud,
			...
			String valorTipoReserva, String docTipoDocumento) {
		super();
	...
	public Timestamp getCmcreationDate() {
		return cmcreationDate;
	}
	public void setCmcreationDate(Timestamp cmcreationDate) {
		this.cmcreationDate = cmcreationDate;
	}
	...
	public void setCmSubTipoTramite(String cmSubTipoTramite) {
		this.cmSubTipoTramite = cmSubTipoTramite;
	}
